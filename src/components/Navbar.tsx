    ...
    <main className="">
      ...
      {isModalOpen && (
        <>
          <div
            onClick={handleModalOpen}
            className="fixed h-screen w-full top-0 left-0 dark:bg-[#f1f0f060] bg-[#000000] "
          ></div>
          <div className="nav-wrapper absolute top-0 z-20 left-0 p-5 flex-col justify-start items-start gap-10 h-screen bg-[#191919] xl:hidden md:flex md:w-[50%] sm:flex ">
            <div className="nav-link flex justify-between items-center w-full">
              <h1 className="uppercase ">ASHMAL</h1>
              <button
                type="button"
                onClick={handleModalOpen}
